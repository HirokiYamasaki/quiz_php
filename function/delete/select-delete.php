...
<head>
    ...
    <link rel="stylesheet" href="select-delete.css">
...
<body>
    ...
    <div class="container">
        <div class="content">
            <div class="">
                <div class="">
                    <h2>削除するクイズを選んで下さい</h2>
                </div>
                <div class="center">
                <?php while ($mondai = $mondais->fetch()): ?>
                    <ul>
                        <li class="one_quiz"><a href="deletell.php?id=<?php echo $mondai['id']; ?>"><?php print($mondai['title']) ?></a></li>
                    </ul>
                    <?php $i = $i +1 ?>
                <?php endwhile; ?>
                </div>
